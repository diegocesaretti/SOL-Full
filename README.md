...
## Incluido en `0.13.0-preview.19`

| Componente | Versión / tag | Artefacto |
| --- | --- | --- |
| SOL Core | `main@f64934b` / `sol-windows-latest` | `SOL-Core-Windows.zip` |
...
```text
SOL-Full-Windows-0.13.0-preview.19.zip
├─ SOL/
├─ plugins/
│  ├─ Nexo.solplugin
...
```text
dist/SOL-Full-Windows-0.13.0-preview.19.zip
dist/SHA256SUMS.txt
```
